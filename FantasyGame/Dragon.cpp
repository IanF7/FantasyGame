...
void Dragon::setStats()
{
	...
	do
	{
		...
		difficulty != "extreme");
	//sets health equal to 70 and reward eqaul to 70
	if (difficulty == "easy")
	{
		setHealth(70);
		setReward(70);
	}
	//sets health equal to 80 and reward eqaul to 80
	else if (difficulty == "medium")
	{
		setHealth(80);
		setReward(80);
	}
	//sets health equal to 90 and reward eqaul to 90
	else if (difficulty == "hard")
	{
		setHealth(90);
		setReward(90);
	}
	//sets health equal to 100 and reward eqaul to 100
